...
**작성일:** 2026-06-24  
**분석 대상:** 20개 표현형 (19개 질병 + Other Cancer)  
...
### 5.1 CDCS — Coronary Disease (sample n=212 · FDR<0.05 861개 · NES>0: 9 · NES<0: 852)

#### 최대 특징: 99.0% NES<0 (전신 생물학적 과정 광범위 억제)

#### 주요 상향 신호 (11개)

**ECM 리모델링·혈관**
- Import Into Cell (+2.59): 세포 흡수 경로 — 혈관 리모델링 반영
- Collagen Chain Trimerization (+2.21): 심장 섬유화 마커; CAD의 콜라겐 축적
- P2Y Receptors (+2.23): 혈소판 활성화 퓨린 수용체; 혈관 평활근 반응
- Voltage Gated Potassium Channels (+2.09): 혈관 긴장도 이상 반영
- Aminoglycan/GAG Biosynthesis (+2.23): 동맥 플라크에서 프로테오글리칸 축적

**니코틴 수용체 (+2.43)**
- 흡연이 주요 CAD 위험인자인 CDCS 코호트 반영 (뉴질랜드 코호트)

#### 주요 하향 신호 (852개)

**5개 주제별 억제 클러스터**

**1. 번역 기계 (가장 강한 개별 NES)**
- Cytoplasmic Translation (−2.13), Eukaryotic Translation Elongation/Termination (−2.09/−2.08)
- GCN2 Response (−2.06), NMD (−2.07/−2.02)

**2. RNA 스플라이싱 (~31개 경로)**
- Spliceosomal Assembly, U2-type Prespliceosome (~−1.80)

**3. 미토콘드리아·OXPHOS (~27개 경로)**
- Oxidative Phosphorylation (−1.72): Ward et al. 2022에서 CAD에서 13개 미토콘드리아 전사체 억제 보고와 일치

**4. 면역 억제 (~55개 경로)**
- JAK-STAT After IL-12 (−1.82), NF-κB (BCR/TNFR2/NIK, −1.74~−1.77)
- BCR·TCR 신호 (−1.63~−1.69), IL-1/IL-12 (−1.67~−1.74)
- 안정 CAD에서 면역 임계값 재설정; 급성 MI의 면역 과활성과 다름

**5. 세포주기·프로테오스타시스 (~195개 경로)**
- NOTCH4 조절 (−1.83), GSK3B-매개 NFE2L2 분해 (−1.83)
- ROBO 수용체 신호 (−1.92~−1.97)
...
| 19 | **CDCS (CAD)** | 212 | HIGH | ECM/콜라겐 (+2.21); P2Y 수용체; 칼륨 채널; 니코틴 (+2.43) | 번역 (−2.13); OXPHOS (−1.72); 면역 NF-κB (−1.77); 스플라이싱 (~31개) | 852/861 경로 하향 = 만성 허혈에 의한 전신 생물학적 기능 광범위 억제 |
| 20 | **Pre-eclampsia** | 59 | MODERATE-HIGH | **Neurexins/Neuroligins (+2.42)** (Moufarrej 2022 신경근육 발견의 pathway 수준 구체화); DNA 메틸화 | 번역 최강 (−2.27); 선천 면역/IFN (−1.99); 스플라이싱; 지질단백질 | ★ Neurexin/Neuroligin이 임신중독증 cfRNA 최강 신호 (첫 pathway 수준 증거) |
| 21 | **Other Cancer** | 16 | HIGH | **RhoGTPase 완전 세트** (RHOB/C/A/Q + CDC42 + RAC1, NES ≥ 2.0); 세포 기질 접합; VEGF; RUNX1 | 번역 극단 (−3.10, 전체 최저); OXPHOS (−2.55); **SLIT/ROBO** (−2.89); 프로테아솜; Wnt 분해 억제 | 범암 RhoGTPase 침습 서명이 이질적 암종 집합에서 일관되게 검출됨 |
