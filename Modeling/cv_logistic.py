...
DET_RATE_MAX = config.MODELING_PARAMS["low_det_thr"]
...
def bernoulli_rqr(p_detect, y, seed=None):
...
def main():
    ...
    meta_path = config.CV_RESULTS_DIR / "cv_logistic_stats.csv"
    zscores_path = config.CV_RESULTS_DIR / "cv_logistic_zscores.pkl"
    failures_path = config.CV_RESULTS_DIR / "cv_logistic_failures.csv"
